...
const Details = () => {
  return (
    <div className="w-full max-w-2xl mx-auto bg#330867] rounded-lg overflow-hidden shadow-2xl border border-[#537895]">
    {/* Window Dots */}
    ...
    {/* Code Block */}
    <pre className="p-10 text-sm font-mono leading-relaxed">
      <code>
